...
export default class WasabeeMe {
  ...
  store() {
    localStorage[statics.constants.AGENT_INFO_KEY] = JSON.stringify(this);
  }

  remove() {
    delete localStorage[statics.constants.AGENT_INFO_KEY];
  }

  static localGet() {
    const lsme = localStorage[statics.constants.AGENT_INFO_KEY];
